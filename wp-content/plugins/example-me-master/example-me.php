...
//namespace Example_Me\App\Templates\Frontend;
...
function run_example_me() {
	...
	{  
		echo "0"; 
		 $insert_data = array(  
			  'order_id'     =>     mysqli_real_escape_string($data->con, $_POST['order_id']),  
			  'transaction_id'          =>     mysqli_real_escape_string($data->con, $_POST['transaction_id'])  
		 );  
		 echo "1";
		 if($data->insert('order_transaction_ids', $insert_data))  
		 {  
